...
if (isset($_POST['excluir']))
{
    ...
    try {
        $procedureExcluir = "CALL excluirEditora($id)";
        if ($conexao->query($procedureExcluir) === TRUE) {
            header('Location: index.php');
        }
    }
    catch (mysqli_sql_exception $exception) {
        echo "Erro ao excluir editora: (" . $conexao->errno . ") " . $conexao->error;
    }
}
?>
...
<head>
    ...
    <title>Biblioteca - Excluir Editora</title>
        ...
        <form method="post">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><input disabled type="text" id="nome" name="nome" value="<?php echo $resultado['nm_editora'] ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input disabled type="text" id="contato" name="contato" value="<?php echo $resultado['cd_contato'] ?>"></td>
                </tr>
                <tr>
                    <td colspan="2">
