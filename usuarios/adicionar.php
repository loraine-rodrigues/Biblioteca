...
if (isset($_POST['adicionar']))
{
    ...
    try {
        $procedureInserir = "CALL inserirUsuario($cpf, '$nome', '$endereco', '$telefone')";
        ...
        echo "Erro ao adicionar usuários: (" . $conexao->errno . ") " . $conexao->error;
    }
}
?>
...
<head>
    ...
    <title>Biblioteca - Adicionar Usuário</title>
