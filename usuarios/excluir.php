...
if (isset($_POST['excluir']))
{
    ...
    try {
        $procedureExcluir = "CALL excluirUsuario($cpf)";
        if ($conexao->query($procedureExcluir) === TRUE) {
            header('Location: index.php');
        }
    }
    catch (mysqli_sql_exception $exception) {
        echo "Erro ao excluir usuário: (" . $conexao->errno . ") " . $conexao->error;
    }
}
?>
...
<head>
    ...
    <title>Biblioteca - Excluir Usuário</title>
        ...
        <form method="post">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><input disabled type="text" id="nome" name="nome" value="<?php echo $resultado['nm_nome'] ?>"></td>
                </tr>
                <tr>
