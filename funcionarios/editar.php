...
if (isset($_POST['atualizar']))
{
    ...
    try {
        $procedureAtualizar = "CALL atualizarFuncionario($cpf, '$nome', '$endereco', '$telefone', '$salario', '$funcao')";
        if ($conexao->query($procedureAtualizar) === TRUE) {
            header('Location: index.php');
        }
    }
    catch (mysqli_sql_exception $exception) {
        echo "Erro ao editar funcionário: (" . $conexao->errno . ") " . $conexao->error;
    }
}
?>
...
<head>
    ...
    <title>Biblioteca - Editar Funcionário</title>
        ...
        <form method="post">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><input type="text" id="nome" name="nome" placeholder="Informe o nome" value="<?php echo $resultado['nm_funcionario'] ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="salario" name="salario" placeholder="Informe o salário" value="<?php echo $resultado['vl_salario'] ?>"></td>
                </tr>
                <tr>
                    <td><label for="funcao">Função</label></td>
                    <td><input type="text" id="funcao" name="funcao" placeholder="Informe o função" value="<?php echo $resultado['nm_funcao'] ?>"></td>
                </tr>
                <tr>
                    <td colspan="2">
