...
if (isset($_POST['adicionar']))
{
    ...
    try {
        $procedureInserir = "CALL inserirLivro($id, '$titulo', '$genero', '$ano')";
        ...
        echo "Erro ao adicionar livro: (" . $conexao->errno . ") " . $conexao->error;
    }
}
?>
    ...
    <form method="post">
        <table class="table">
            ...
            <tr>
                ...
                <td><input type="text" id="titulo" name="titulo" placeholder="Informe o título"></td>
            </tr>
            <tr>
                <td><label for="genero">Gênero</label></td>
                <td><input type="text" id="genero" name="genero" placeholder="Informe o gênero"></td>
            </tr>
            <tr>
                <td><label for="anoPublicacao">Ano de publicação</label></td>
                <td><input type="text" id="anoPublicacao" name="anoPublicacao" placeholder="Informe o ano publicação"></td>
            </tr>
            <tr>
                <td colspan="2">
