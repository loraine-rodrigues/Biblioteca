...
if (isset($_POST['excluir']))
{
    ...
    try {
        $procedureExcluir = "CALL excluirLivro($id)";
        if ($conexao->query($procedureExcluir) === TRUE) {
            header('Location: index.php');
        }
    }
    catch (mysqli_sql_exception $exception) {
        echo "Erro ao excluir livro: (" . $conexao->errno . ") " . $conexao->error;
    }
}
?>
...
<head>
    ...
    <title>Biblioteca - Excluir Livro</title>
        ...
        <form method="post">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><input disabled type="text" id="titulo" name="titulo" value="<?php echo $resultado['nm_titulo'] ?>"></td>
                </tr>
                <tr>
                    <td><label for="genero">Gênero</label></td>
                    <td><input disabled type="text" id="genero" name="genero" value="<?php echo $resultado['nm_genero'] ?>"></td>
                </tr>
                <tr>
                    <td><label for="anoPublicacao">Ano de publicação</label></td>
                    <td><input disabled type="text" id="anoPublicacao" name="anoPublicacao" value="<?php echo $resultado['aa_publicacao'] ?>"></td>
                </tr>
                <tr>
                    <td colspan="2">
